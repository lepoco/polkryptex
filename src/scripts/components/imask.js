      ...
      },
      {
        ...
        value: function appendWithTail(str, tail) {
          ...
          for (var ci = 0; ci < str.length; ++ci) {
            ...
            var tailAppended =
              !appendDetails.overflow && !this._appendTail(tail).overflow;
      ...
      },
      {
        ...
        value: function remove() {
          ...
          var count =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : this.value.length - from;

          this._value =
            this.value.slice(0, from) + this.value.slice(from + count);
          return new ChangeDetails();
        },
  ...
  var MaskedPattern = (function (_Masked) {
    ...
    function MaskedPattern() {
      ...
      return possibleConstructorReturn(
        this,
        (MaskedPattern.__proto__ || Object.getPrototypeOf(MaskedPattern)).call(
          this,
          _extends({}, MaskedPattern.DEFAULTS, opts)
        )
      );
    }
    ...
    createClass(MaskedPattern, [
      {
        ...
        value: function _update() {
          ...
          get(
            MaskedPattern.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedPattern.prototype),
            "_update",
            this
          ).call(this, opts);
          this._rebuildMask();
          ...
          var _loop = function _loop(_i) {
            if (_this2.groups) {
              ...
              if (gName) {
                ...
                _this2._groupDefs.push(
                  new PatternGroup(_this2, {
                    name: gName,
            ...
            var unmasking =
              type === PatternDefinition.TYPES.INPUT || unmaskingBlock;
            var optional =
              type === PatternDefinition.TYPES.INPUT && optionalBlock;
      ...
      */
      },
      {
        ...
        value: function doValidate() {
          ...
          return (
            this._groupDefs.every(function (g$$1) {
              return g$$1.doValidate.apply(g$$1, toConsumableArray(args));
            }) &&
            (_babelHelpers$get = get(
              MaskedPattern.prototype.__proto__ ||
                Object.getPrototypeOf(MaskedPattern.prototype),
              "doValidate",
              this
      ...
      */
      },
      {
        ...
        value: function _append(str) {
          ...
          for (
            var ci = 0, di = this.mapPosToDefIndex(this.value.length);
            ci < str.length;
            ...
            if (def.type === PatternDefinition.TYPES.INPUT) {
              ...
              resolved =
                chres &&
                (def.unmasking || flags.input || flags.raw) &&
                !flags.tail;
      ...
      },
      {
        ...
        value: function _appendChunks(chunks) {
          ...
          for (var ci = 0; ci < chunks.length; ++ci) {
            ...
            if (fromDef && fromDef.stopAlign)
              details.aggregate(this._appendPlaceholder(stop));
            if (
              details.aggregate(
                this._append.apply(
                  this,
                  [value].concat(toConsumableArray(args))
                )
              ).overflow
            )
              break;
      ...
      */
      },
      {
        ...
        value: function _extractTail() {
          ...
          return new ChunksTailDetails(
            this._extractInputChunks(fromPos, toPos)
          );
        },
      ...
      */
      },
      {
        ...
        value: function extractInput() {
          ...
          for (
            var ci = fromPos, di = this.mapPosToDefIndex(fromPos);
            ...
            if (
              (def.isInput && !def.isHollow) ||
              (flags.raw && !def.isInput && def.isRawInput)
            )
              input += ch;
            ++ci;
          }
      ...
      },
      {
        ...
        value: function _extractInputChunks() {
          ...
          var toDefIndex = this.mapPosToDefIndex(toPos);
          var stopDefIndices = this._charDefs
            .map(function (d, i) {
              return [d, i];
            })
          ...
          var stops = [fromDefIndex].concat(toConsumableArray(stopDefIndices), [
            toDefIndex,
          ]);
          ...
          return stops
            .map(function (s, i) {
              return {
                ...
                value: _this4.extractInput(
                  _this4.mapDefIndexToPos(s),
                  _this4.mapDefIndexToPos(stops[++i])
                ),
              };
            })
      ...
      },
      {
        ...
        value: function _appendPlaceholder(toDefIndex) {
          ...
          for (
            var di = this.mapPosToDefIndex(this.value.length);
            di < maxDefIndex;
            ++di
          ) {
            var def = this._charDefs[di];
      ...
      */
      },
      {
        ...
        value: function nearestInputPos(cursorPos) {
          ...
          if (
            ...
            if (initialDef && !initialDef.isHollow)
              firstFilledInputIndex = initialDefIndex;
          }

          if (
            (firstFilledInputIndex == null && direction == DIRECTION.LEFT) ||
            ...
            for (
              ...
              if (
                firstVisibleHollowIndex == null &&
                nextDef.isHollow &&
                !nextDef.isHiddenHollow
              )
        ...
        get: function get$$1() {
          ...
          return !this._charDefs.some(function (d, i) {
            return (
              d.isInput &&
              !d.optional &&
              (d.isHollow || !_this5.extractInput(i, i + 1))
            );
          });
        },
      },
      {
        ...
        get: function get$$1() {
          ...
          for (
            var ci = 0, di = 0;
            ci < str.length && di < this._charDefs.length;
            ++di
          ) {
            var ch = str[ci];
            var def = this._charDefs[di];
  ...
  var MaskedDate = (function (_MaskedPattern) {
    ...
    */
    ...
    function MaskedDate(opts) {
      ...
      return possibleConstructorReturn(
        this,
        (MaskedDate.__proto__ || Object.getPrototypeOf(MaskedDate)).call(
          this,
          _extends({}, MaskedDate.DEFAULTS, opts)
        )
      );
    }
    ...
    createClass(MaskedDate, [
      {
        ...
        value: function _update(opts) {
          ...
          get(
            MaskedDate.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedDate.prototype),
            "_update",
            this
          ).call(this, opts);
        },
      ...
      */
      },
      {
        ...
        value: function doValidate() {
          ...
          var valid = (_babelHelpers$get = get(
            MaskedDate.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedDate.prototype),
            "doValidate",
            this
  ...
  var HTMLMaskElement = (function (_MaskElement) {
    ...
    function HTMLMaskElement(input) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (
          HTMLMaskElement.__proto__ || Object.getPrototypeOf(HTMLMaskElement)
        ).call(this)
      );
  ...
  */
  var MaskedNumber = (function (_Masked) {
    ...
    function MaskedNumber(opts) {
      ...
      return possibleConstructorReturn(
        this,
        (MaskedNumber.__proto__ || Object.getPrototypeOf(MaskedNumber)).call(
          this,
          _extends({}, MaskedNumber.DEFAULTS, opts)
        )
      );
    }
    ...
    createClass(MaskedNumber, [
      {
        ...
        value: function _update(opts) {
          get(
            MaskedNumber.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedNumber.prototype),
            "_update",
            this
          ).call(this, opts);
          this._updateRegExps();
      ...
      */
      },
      {
        ...
        value: function appendWithTail() {
          ...
          var appendDetails = (_babelHelpers$get2 = get(
            MaskedNumber.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedNumber.prototype),
            "appendWithTail",
            this
          ...
          for (var pos = 0; pos <= beforeTailPos; ++pos) {
            if (this.value[pos] === this.thousandsSeparator) {
              if (
                ...
                (pos === startChangePos &&
                  previousValue[pos] === this.thousandsSeparator)
              ) {
                ++startChangePos;
              }
          ...
          appendDetails.inserted = this.value.slice(
            startChangePos,
            beforeTailPos
          );
  ...
  var MaskedRegExp = (function (_Masked) {
    ...
    function MaskedRegExp() {
      ...
      return possibleConstructorReturn(
        this,
        (MaskedRegExp.__proto__ || Object.getPrototypeOf(MaskedRegExp)).apply(
          this,
          arguments
        )
      );
    ...
    createClass(MaskedRegExp, [
      ...
      */
        value: function _update(opts) {
          ...
          get(
            MaskedRegExp.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedRegExp.prototype),
            "_update",
            this
          ).call(this, opts);
        },
  ...
  var MaskedFunction = (function (_Masked) {
    ...
    function MaskedFunction() {
      ...
      return possibleConstructorReturn(
        this,
        (
          MaskedFunction.__proto__ || Object.getPrototypeOf(MaskedFunction)
    ...
    createClass(MaskedFunction, [
      ...
      */
        value: function _update(opts) {
          ...
          get(
            MaskedFunction.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedFunction.prototype),
            "_update",
            this
          ).call(this, opts);
        },
  ...
  var MaskedDynamic = (function (_Masked) {
    ...
    */
    ...
    function MaskedDynamic(opts) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (MaskedDynamic.__proto__ || Object.getPrototypeOf(MaskedDynamic)).call(
          this,
          _extends({}, MaskedDynamic.DEFAULTS, opts)
        )
      );
    ...
    createClass(MaskedDynamic, [
      {
        ...
        value: function _update(opts) {
          get(
            MaskedDynamic.prototype.__proto__ ||
              Object.getPrototypeOf(MaskedDynamic.prototype),
            "_update",
            this
          ).call(this, opts);
      ...
      */
      },
      {
        ...
        value: function _append(str) {
          ...
          str = this.doPrepare.apply(
            this,
            [str].concat(toConsumableArray(args))
          );

          var details = this._applyDispatch.apply(
            this,
            [str].concat(toConsumableArray(args))
          );
          ...
          if (this.currentMask) {
            ...
            details.aggregate(
              (_currentMask = this.currentMask)._append.apply(
                _currentMask,
                [str].concat(toConsumableArray(args))
              )
            );
      ...
      },
      {
        ...
        value: function _applyDispatch() {
          ...
          this.currentMask = this.doDispatch.apply(
            this,
            [appended].concat(toConsumableArray(args))
          );
      ...
      */
        value: function remove() {
          ...
          if (this.currentMask) {
            ...
            details
              .aggregate(
                (_currentMask2 = this.currentMask).remove.apply(
                  _currentMask2,
                  arguments
                )
              )
      ...
      },
      {
        ...
        value: function extractInput() {
          ...
          return this.currentMask
            ? (_currentMask3 = this.currentMask).extractInput.apply(
                _currentMask3,
                arguments
              )
            : "";
      ...
      */
      },
      {
        ...
        value: function _extractTail() {
          ...
          return this.currentMask
            ? (_currentMask4 = this.currentMask)._extractTail.apply(
                _currentMask4,
      ...
      */
      },
      {
        ...
        value: function nearestInputPos() {
          ...
          return this.currentMask
            ? (_currentMask5 = this.currentMask).nearestInputPos.apply(
                _currentMask5,
                toConsumableArray(args)
              )
            : (_babelHelpers$get2 = get(
                MaskedDynamic.prototype.__proto__ ||
                  Object.getPrototypeOf(MaskedDynamic.prototype),
                "nearestInputPos",
                this
