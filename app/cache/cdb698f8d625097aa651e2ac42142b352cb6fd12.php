...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h2><?php echo Polkryptex\Core\Components\Translator::translate('Dashboard'); ?></h2>
        </div>
    </div>
</div>
...
<?php /**PATH E:\www\rdev\polkryptex\app\common\views/dashboard/dashboard.blade.php ENDPATH**/ ?>