...
/**
 * Additional logic for the views/dashboard/payments-request.blade view.
 *
 * @author  Pomianowski <kontakt@rapiddev.pl>
 * @license GPL-3.0 https://www.gnu.org/licenses/gpl-3.0.txt
 * @since   1.0.0
 */
final class PaymentsRequestComposer extends Composer implements \App\Core\Schema\Composer
{
