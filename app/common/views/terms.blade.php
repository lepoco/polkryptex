  ...
  <div class="row">
    ...
    <div class="col-12 -mb-5">
      <div>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
              refers to THEWONDERFULCOMPANYWHOMAKEIT (i mean, it's a college project).</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to @url(), accessible from <a href="@url()"
                rel="external nofollow noopener" target="_blank">@url()</a></p>
          </li>
          <li>
        ...
        <h4 class="-mt-3">Acknowledgment</h4>
        ...
        <p>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the
          <a href="@url('privacy')">Privacy Policy</a> of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use
          ...
          Service.</p>
        <h4 class="-mt-3">Links to Other Websites</h4>
        ...
        <h4 class="-mt-3">Limitation of Liability</h4>
        <p>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its
          ...
          limited to the amount actually paid by You through the Service or 1 EUR if You haven't purchased anything
        ...
        <h4 class="-mt-3">"AS IS" and "AS AVAILABLE" Disclaimer</h4>
        ...
        <h4 class="-mt-3">Governing Law</h4>
        <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the
          ...
          laws.</p>
        <h4 class="-mt-3">Disputes Resolution</h4>
        ...
        <h4 class="-mt-3">For European Union (EU) Users</h4>
        ...
        <h4 class="-mt-3">United States Legal Compliance</h4>
        ...
        <h4 class="-mt-3">Severability and Waiver</h4>
        <h5>Severability</h5>
        ...
        <h4 class="-mt-3">Translation Interpretation</h4>
        <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
          You agree that the original English text shall prevail in the case of a dispute.</p>
        <h4 class="-mt-3">Changes to These Terms and Conditions</h4>
        ...
        <ul>
          <li>By email: lol we don't have an email address. It's just a college project</li>
        </ul>
      </div>
    </div>
  </div>
