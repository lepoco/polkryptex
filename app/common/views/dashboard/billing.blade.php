@extends('layouts.app', [
'title' => \App\Core\Facades\Translate::string('Billing')
])
@section('content')
...
<div class="dashboard container -mt-5 -mb-5">
  <div class="row">
    <div class="col-12">
      <h4 class="-font-secondary -fw-700 -pb-3 -reveal">@translate('Billing')</h4>
    </div>
    <div class="col-12">
      <form id="updateBilling" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 -reveal">
            <div class="floating-input">
              <input class="floating-input__field" type="tel" placeholder="@translate('Phone')" name="phone"
                value="{{ $billing->getPhone() ?? '' }}">
