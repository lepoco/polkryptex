...
<form id="signin">
  ...
  <button type="submit" class="btn btn-dark btn-mobile -mb-1">@translate('Sign in')</button> <a href="@url"
    class="btn btn-secondary btn-mobile -mb-1">@translate('Back to home')</a>
</form>
@endsection