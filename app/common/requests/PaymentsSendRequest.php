...
final class PaymentsSendRequest extends Request implements \App\Core\Schema\Request
{
  ...
  public function process(): void
  {
    ...
    if (!TransactionsRepository::PaymentsSend($user, $selectedWallet, $this->get('amount'), $paymentMethod)) {
    ...
    Statistics::push(\App\Core\Data\Statistics::TYPE_TRANSACTION, 'TRANSACTION:PaymentsSend');
